  ...
  return (
    <mjml>
      ...
      <mj-body background-color={colors.white}>
        <mj-section background-color="#ECF9F3" padding="40px 0px 30px 0px">
          <mj-column>
            ...
            <mj-text
              ...
              color={colors.grey[2]}
            >
              You just minted your Badge as NFT
            </mj-text>
            <mj-image
              padding-top="24px"
              padding-bottom="16px"
              width="200px"
              border-radius="16px"
              src="https://placeimg.com/200/185/tech"
            />
          </mj-column>
        </mj-section>
        <mj-section padding="30px">
          ...
          <mj-text font-size="14px" color={colors.grey[2]}>
            Congratulations on the successful minting of your Badge NFT!. If
            this is your first ever NFT, Welcome to Web3! This Proof of
            Contribution is now yours to own forever on the Polygon blockchain.
            <br />
            <br />
          ...
          <mj-button
            ...
            target="_blank"
            rel="noreferrer"
            href={useData("opensea_link", rewardData.link)}
            align="left"
          >
            Check Badge NFT on Opensea
          </mj-button>
          <mj-spacer height="16px" />
          <mj-text font-size="14px" color={colors.grey[2]}>
            If above button is not clickable, use the link below
            <br />
            {useData("opensea_link", rewardData.link)}
            <br />
            <br />
            For any questions, check out our FAQs or contact us at{" "}
            <a
              href="mailto:hello@aviyel.com"
              target="_blank"
              style={`color:${colors.grey[1]};white-space:nowrap;`}
            >
              hello@aviyel.com
            </a>
            <br />
